    ...
    <client-only>
      <v-dialog v-model="showRegisterDialog" persistent width="1300">
        <RegisterCategory
          ...
          api_url="landing/all-requirement-categories"
          store_url="landing/requiremnt-categories"
          type="sub"
      ...
      <v-row no-gutters>
        ...
        <v-col cols="12">
          ...
          >
            <CustomButton
              ...
              :text="$tr('create_item', $tr('sabcategory'))"
              type="primary"
            />
          </PageFilters>
        </v-col>
        ...
        <v-col cols="12">
          <CustomPageActions
            ...
            :routeName="'landing/requiremnt-sub-categories'"
            :subSystemName="'requiremnt SubCategory'"
...
import RequirementSubCategories from "~/configs/pages/landing/requirement/RequirementCategory";
...
export default {
  ...
  data() {
    return {
      ...
      headers: RequirementSubCategories(this).headers,
      tabItems: RequirementSubCategories(this).tabItems,
      breadcrumb: RequirementSubCategories(this).SubCategoryBreadcrumb,
      selectedItems: [],
      tableKey: 0,
      tabIndex: 0,
      options: {},
  ...
  asyncData({ params }) {
    return { slug: params.requirement_subcategory_id };
  },
  ...
  methods: {
    ...
    async fetchSubCategories() {
      ...
      this.fetchSubCategoriesData({
        data: data,
        url: "landing/requiremnt-sub-categories",
      });
    },
    ...
    async searchById(code) {
      ...
      const result = await this.searchSubCategory({
        data: data,
        url: "/search-sub-category-requiremnt",
      });
      if (result) {
