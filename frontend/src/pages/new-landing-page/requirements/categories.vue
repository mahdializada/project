      ...
      <v-row no-gutters>
        ...
        <v-col cols="12">
          <CustomPageActions
            ...
            :routeName="'landing/requiremnt-categories'"
            :subSystemName="'requiremnt Category'"
...
import RequirementCategories from "~/configs/pages/landing/requirement/RequirementCategory";
...
export default {
  ...
  data() {
    return {
      ...
      headers: RequirementCategories(this).headers,
      tabItems: RequirementCategories(this).tabItems,
      breadcrumb: RequirementCategories(this).CategoryBreadcrumb,
      selectedItems: [],
      tableKey: 0,
      tabIndex: 0,
      options: {},
  ...
  methods: {
    ...
    async viewSubCategories(id) {
      window.location.pathname =
        "/new-landing-page/requirements/subcategories/" + id;
    },
    ...
    async fetchCategories() {
      ...
      this.fetchCategoriesData({
        data: data,
        url: "landing/requiremnt-categories",
      });
    },
    ...
    async searchById(code) {
      ...
      const result = await this.searchCategory({
        data: data,
        url: "/search-category-requiremnt",
      });
      if (result) {
