      ...
      <v-row no-gutters>
        ...
        <v-col cols="12">
          <CustomPageActions
            ...
            :routeName="'landing/worker-sub-categories'"
            :subSystemName="'worker SubCategory'"
...
import WorkerSubCategories from "~/configs/pages/landing/worker/WorkerCategory";
...
export default {
  ...
  data() {
    return {
      ...
      headers: WorkerSubCategories(this).headers,
      tabItems: WorkerSubCategories(this).tabItems,
      breadcrumb: WorkerSubCategories(this).SubCategoryBreadcrumb,
      selectedItems: [],
      tableKey: 0,
      tabIndex: 0,
      options: {},
  ...
  methods: {
    ...
    async fetchSubCategories() {
      ...
      this.fetchSubCategoriesData({
        data: data,
        url: "landing/worker-sub-categories",
      });
    },
    ...
    async searchById(code) {
      ...
      const result = await this.searchSubCategory({
        data: data,
        url: "/search-sub-category-worker",
      });
      if (result) {
