      ...
      <v-row no-gutters>
        ...
        <v-col cols="12">
          <CustomPageActions
            ...
            :routeName="'landing/product-sub-categories'"
            :subSystemName="'product SubCategory'"
...
export default {
  ...
  data() {
    return {
      ...
      breadcrumb: ProductCategories(this).SubCategoryBreadcrumb,
      selectedItems: [],
      tableKey: 0,
      tabIndex: 0,
      options: {},
  ...
  asyncData({ params }) {
    return { slug: params.product_sub_category_id };
  },
  ...
  methods: {
    ...
    async fetchSubCategories() {
      ...
      this.fetchSubCategoriesData({
        data: data,
        url: "landing/product-sub-categories",
      });
    },
    ...
    async searchById(code) {
      ...
      const result = await this.searchSubCategory({
        data: data,
        url: "/search-sub-category-product",
      });
      if (result) {
