      ...
      <v-row no-gutters>
        ...
        <v-col cols="12">
          <CustomPageActions
            ...
            :routeName="'landing/skill-categories'"
            :subSystemName="'skill Category'"
...
export default {
  ...
  data() {
    return {
      ...
      breadcrumb: SkillCategories(this).CategoryBreadcrumb,
      selectedItems: [],
      tableKey: 0,
      tabIndex: 0,
      options: {},
  ...
  methods: {
    ...
    async viewSubCategories(id) {
      window.location.pathname = "/new-landing-page/skills/subcategories/" + id;
    },

    async fetchCategories() {
      let data = this.fetchOptions();
      this.fetchCategoriesData({ data: data, url: "landing/skill-categories" });
    },
