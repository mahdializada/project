...
export default {
  ...
  computed: {
    ...
    getSystems() {
      console.log(this.selectedSystems?.length, this.systems?.length);
      if (this.selectedSystems?.length == this.systems?.length) {
        console.log("system mutched");
        return [
          { id: "Unselect All", name: "Unselect All", logo: "Unselect All" },
          ...this.systems,
        ];
      } else {
        console.log("not mutched");
        return [
          { id: "Select All", name: "Select All", logo: "Select All" },
          ...this.systems,
        ];
      }
    },
  ...
  methods: {
    ...
    addSelectedSystems() {
      ...
      if (this.selectedSystemId == "Select All") {
        this.selectedSystemId = "";
        this.selectedSystems = structuredClone(this.systems);
        return;
      } else if (this.selectedSystemId == "Unselect All") {
