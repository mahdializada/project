<template>
  <div class="">
    <p class="mb-1 custom-input-title">
      {{ label ? label : $tr("item_required", $tr("phone")) }}
    </p>
    <v-text-field
      class="custom-input"
      dense
      :placeholder="placeholder ? placeholder : $tr('phone')"
    ...
    >
      <template v-slot:prepend-inner>
        <v-select
          ...
          class="ma-0 pa-0 phone-number-input__select__option"
          :menu-props="{
            bottom: true,
            offsetY: true,
            nudgeTop: -10,
...
export default {
  ...
  async fetch() {
    ...
    //   const response = await this.$axios.get("countries?phone_code=true");
...
<style>
.phone-number-input__select__option .v-select__slot {
  margin: -3px !important;
}
.phone-number-input__select__option .v-input__append-inner {
  margin: 0px !important;
}
.phone-number-input__select__option {
  max-width: 120px !important;
  min-width: 120px !important;
}
.phone-number-input__select__option > .v-input__control > .v-input__slot:before,
.phone-number-input__select__option > .v-input__control > .v-input__slot:after {
