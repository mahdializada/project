...
export default {
  ...
  methods: {
    ...
    getCount() {
      try {
        let counts1 = {};
        if (this.subsystem == "advertisemnt") {
          counts1 = this.tabs[4]?.count?.item_code_tabs;
        } else {
          counts1 = this.tabs;
        }
        this.itemCodeTab =
