...
import ProjectOperations from "../../components/advertisement/ProjectOperations.vue";
...
export default {
	...
	methods: {
		...
		openInsertDialog() {
			this.$refs.projectOperationRef.toggle();
		},
		...
		async onEdit() {
			if (this.selectedItems.length == 1) {
				...
				this.$refs.projectOperationRef.toggle(firstItem);
			} else {
				this.$toasterNA(
					"red",
