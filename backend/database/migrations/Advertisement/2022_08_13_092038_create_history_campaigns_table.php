...
class CreateHistoryCampaignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_campaigns', function (Blueprint $table) {
            ...
            $table->enum('system_status', HistoryCampaign::$STATUSES)->default("ACTIVE");
    ...
    {
        Schema::dropIfExists('history_campaigns');
    }
}
