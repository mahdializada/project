...
class CreateManualUploadAdsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('manual_upload_ads', function (Blueprint $table) {
            ...
            $table->enum('system_status', HistoryAdMU
                ::$STATUSES)->default("ACTIVE");

            // CRM
            $table->integer("crm_total_orders")->nullable();
            ...
            $table->foreignUuid('adset_id')->constrained("manual_upload_adsets")->cascadeOnUpdate()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('manual_upload_ads');
    }
}
