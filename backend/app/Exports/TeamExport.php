...
class TeamExport extends DefaultValueBinder implements
    WithEvents,
    WithHeadings,
    shouldAutoSize,
    withMultipleSheets,
    ...
    WithColumnFormatting
{
    ...
    {
        $sheets = [];
        $sheets['teams'] = new TeamExport($this->schedule_type, $this->departments);
    ...
    public function styles(Worksheet $sheet): array
    {
        ...
        $sheet->setCellValue('A4', 'Team Bulk Upload Template');
        $alignment = [
