...
use App\Repositories\SingleSales\ProductStudyCategoryRepository;
use Illuminate\Http\Request;

class ProductStudyCategoryController extends Controller
{
    /**
    ...
    {
        $this->repository = new ProductStudyCategoryRepository();
    }
