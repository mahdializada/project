...
use App\Repositories\SingleSales\ProductSourceValueRepository;

class ProductSourceValueController extends Controller
{
    /**
    ...
    {
        $this->repository = new ProductSourceValueRepository();
    }
